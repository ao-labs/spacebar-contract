...
*It concats base uri with the given token id*
...
| Name | Type | Description |
|---|---|---|
| _0 | string | The uri of the token with the given id |
...
*The error for exceeding the maximum token id which is type uint24&#39;s max (16777215)*
